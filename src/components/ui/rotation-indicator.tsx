    ...
    return (
        <group rotation={[Math.PI / 2, 0, 0]}>
            ...
            <mesh key="outer-arc" geometry={outerArcGeometry} >
                <meshPhongMaterial color={baseColor} transparent opacity={0.3} side={THREE.DoubleSide} />
...
export const RotationIndicator = ({
    ...
    return (
        <div className="w-full h-full z-20 flex items-center justify-center pointer-events-none">
            <Canvas
                resize={{
                    scroll: false,
                ...
                camera={{
                    ...
                    rotation: [-1.1821874093507672, -0.8317947367899591, -1.0649438353066807]
                }}
            ...
            {/* Overlay children */}
            <div key="overlay-children" className="absolute inset-0 pointer-events-none">
                {children}
            </div>
        </div>
    );
