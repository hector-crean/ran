...
// A simple check to see if a value is a MotionValue.
function isMotionValue(v: any): v is MotionValue {
...
export const Sequence = ({
  ...
  const handleRepaint = useCallback((v: number) => {
    ...
    let { width, height, x, y } = objectFit(
      canvas.clientWidth,
      canvas.clientHeight,
      image.width,
      image.height,
