      ...
      >
        ...
        >
          ...
          >
            ...
            <motion.div
              key="tooltip"
              className="absolute flex flex-col items-center justify-center rounded-full shadow-sm"
              style={{
                width: "fit-content",
            ...
            >
              <div className="px-2 py-1 text-sm whitespace-nowrap text-white sm:text-lg lg:text-2xl">
                {sliderText}
              </div>
            </motion.div>
          </div>
