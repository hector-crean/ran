...
type DragDropGridProps = Record<string, unknown>;
  ...
  return (
    <div ref={containerRef} className="relative isolate h-full w-full">
      ...
      <motion.div
        ...
        className="absolute top-1/2 left-1/2 z-0 h-10 w-10 -translate-x-1/2 -translate-y-1/2 cursor-pointer border-1 border-white"
      />
...
function Line({
  ...
  return (
    <motion.div
      className="absolute top-1/2 left-1/2 -z-0 h-1 w-1/2 -translate-x-1/2 -translate-y-1/2 border-t-1 border-dashed border-white"
      initial={false}
