...
export const RotationIndicator3D = ({
    ...
    const { innerArc, outerArc } = useMemo(() => {
        ...
        const outerArc = a.cornerRadius(0.5 * (outerArcOuterRadius - outerArcInnerRadius))({
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <motion.g style={{ transform: `translate(${centerX}px, ${centerY}px)` }}>
            ...
            >
                <motion.div className="w-6 h-6 bg-red-500 rounded-full"></motion.div>
            </motion.div>
        </motion.div>
    );
};
