...
export const getCentroid = (geometry: Geometry): { x: number; y: number } => {
  switch (geometry.type) {
    ...
    case "MultiLineString":
      ...
      return {
        x: sumLineX / lineCentroids.length,
        y: sumLineY / lineCentroids.length,
      };
    ...
    case "Polygon":
      ...
      return {
        x: sumPolyX / ringCoords.length,
        y: sumPolyY / ringCoords.length,
      };
    ...
    case "MultiPolygon":
      ...
      return {
        x: sumMultiX / polygonCentroids.length,
        y: sumMultiY / polygonCentroids.length,
      };
...
export const renderConvexHull = (
  ...
  return <path d={pathData} {...baseProps} />;
};
